...
try:
    ...
    __version__ = get_package_version(__file__, 'lvmbrain') or 'dev'
...
.. |lvmbrain_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lvmbrain')
...
man_pages = [
    (master_doc, 'lvmbrain', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/lvmbrain'
